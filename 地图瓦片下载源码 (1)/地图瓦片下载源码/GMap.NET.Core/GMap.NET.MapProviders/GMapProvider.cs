...
namespace GMap.NET.MapProviders
{
    ...
    public class GMapProviders
    {
        ...
        //public static readonly GaodeMapProvider GaodeMapInstance = GaodeMapProvider.Instance;

        //public static readonly BaiduMapProvider BaiduMapInstance = BaiduMapProvider.Instance;
    ...
    public abstract class GMapProvider
    {
        ...
        private string _urlFormat = "";//"http://webrd01.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=7&x={0}&y={1}&z={2}";
        /// <summary>
        /// 地图地址
        /// </summary>
        ...
        public virtual void SetDbId(Guid providerID)
        {
