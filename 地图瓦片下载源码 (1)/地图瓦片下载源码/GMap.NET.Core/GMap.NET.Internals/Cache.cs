...
namespace GMap.NET.Internals
{
    ...
    public class CacheLocator
   {
      ...
      {
#if !PocketPC
          location = Application.StartupPath + Path.DirectorySeparatorChar + "GMap.NET" + Path.DirectorySeparatorChar;
   ...
   internal class Cache : Singleton<Cache>
   {
      ...
      public Cache()
      {
...
#endif
         {
            ...
            string oldCache = Application.StartupPath + Path.DirectorySeparatorChar + "GMap.NET" + Path.DirectorySeparatorChar;
