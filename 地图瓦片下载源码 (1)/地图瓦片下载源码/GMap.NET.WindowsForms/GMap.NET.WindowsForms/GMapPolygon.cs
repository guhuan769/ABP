...
namespace GMap.NET.WindowsForms
{
...
#endif
   {
       ...
       protected Color _ctrlColor = Color.FromArgb(155, Color.MidnightBlue);
...
#if !PocketPC
      public static readonly Pen DefaultStroke = new Pen(Color.FromArgb(155, Color.MidnightBlue), 2);
#else
