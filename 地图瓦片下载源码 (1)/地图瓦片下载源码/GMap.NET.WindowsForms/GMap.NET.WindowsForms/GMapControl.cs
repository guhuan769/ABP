...
namespace GMap.NET.WindowsForms
{
   ...
   public partial class GMapControl : UserControl, Interface
   {
      ...
      /// <summary>
      /// occurs when doubleclicked on marker
      /// </summary>
      public event MarkerClick OnMarkerDoubleClick;
      ...
      //lgj
      private System.Windows.Forms.Cursor _myCursor = System.Windows.Forms.Cursors.Arrow;
      public System.Windows.Forms.Cursor MyCursor
      {
          set
          {
              _myCursor = value;
      ...
      internal void SetCursorHandOnEnter()
      {
          if (overObjectCount <= 0 && Cursor != Cursors.Hand)
          {
              ...
              cursorBefore = this.Cursor;
              //lgj
              this.Cursor = _myCursor == System.Windows.Forms.Cursors.Arrow ? Cursors.Hand : _myCursor;
          }
      }
