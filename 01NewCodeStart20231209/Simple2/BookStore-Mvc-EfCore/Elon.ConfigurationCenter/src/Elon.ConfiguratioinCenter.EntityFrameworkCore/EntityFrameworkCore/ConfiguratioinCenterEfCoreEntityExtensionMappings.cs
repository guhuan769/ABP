...
public static class ConfiguratioinCenterEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ConfiguratioinCenterModuleExtensionConfigurator CLASS (in the Domain.Shared project)
