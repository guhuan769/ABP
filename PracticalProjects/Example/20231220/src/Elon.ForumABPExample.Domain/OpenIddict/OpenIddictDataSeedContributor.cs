...
namespace Elon.ForumABPExample.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ForumABPExample") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ForumABPExample", DisplayName = "ForumABPExample API", Resources = { "ForumABPExample" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["ForumABPExample_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["ForumABPExample_Web:RootUrl"]!.EnsureEndsWith('/');

            /* ForumABPExample_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["ForumABPExample_Web:ClientSecret"] ?? "1q2w3e*",
